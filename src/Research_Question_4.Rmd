...
```{r}
pagerank_2018 <- read.csv("domain_only_graphs/2018_top_10000_pagerank_nodes.csv")
pagerank_2024 <- read.csv("domain_only_graphs/2024_top_10000_pagerank_nodes.csv")
head(pagerank_2018)
```
...
edges_2018 <- read.csv("domain_only_graphs/2018_top_10000_pagerank_edges.csv")
edges_2024 <- read.csv("domain_only_graphs/2024_top_10000_pagerank_edges.csv")
